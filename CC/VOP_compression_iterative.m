function [fileout]=VOP_compression_iterative(filename_in,eps_G,R,Sglobal,name_VOP,use_Sglobal,max_num_VOPs)
...
while num_vops<max_num_VOPs
    ...
    if not(too_many_vops)
        ...
        fileout = cat(1, fileout, ['VOP_SOR_' name_VOP '_' num2str(eps_G) '.mat']);
